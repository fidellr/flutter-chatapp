...
class ChatScreen extends StatefulWidget {
  // Provide state for ChatScreenState class
  @override
...
class ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  // _ / underscore makes it private to its class
  ...
  void _handleSubmitted(String text) {
    ...
    if (text.length == 0) {
      print('You should pass any text rather than an empty fields');
    } else {
      setState(() {
